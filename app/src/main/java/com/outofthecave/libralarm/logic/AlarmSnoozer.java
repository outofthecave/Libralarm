...
public class AlarmSnoozer extends BroadcastReceiver {
    @Override
    public void onReceive(Context context, Intent intent) {
        ...
        Needle.onBackgroundThread().execute(new UiRelatedTask<AlarmData>() {
            ...
            protected void thenDoUiRelatedWork(@NonNull AlarmData alarmData) {
                Log.d("AlarmSnoozer", String.format("Retrieved %s alarm(s).", alarmData.alarms.size()));
                ...
                TriggeringAlarmActionHandler.snoozeAlarms(context, alarms, idToSnoozedAlarm);
            }
        });
    }
}
